...
const (
	// N3000NodeLabel
	N3000NodeLabel = "fpga.intel.com/intel-accelerator-present="
	// N3000DaemonNamespace contains the name of the n3000 namespace
	N3000DaemonNamespace = "n3000-operators-resources"
	...
	N3000DaemonsetDiscoveryName = "n3000-discovery"
	// N3000NodeCRDName contains the name of the n3000node policies CRD
	N3000NodeCRDName = "n3000clusters.fpga.intel.com"
